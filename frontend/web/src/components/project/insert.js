...
function Insert ({history}) {
    ...
    <>
    <hidden>
        <Link to="/admin/projectBoard" id="link"></Link>
    </hidden>
    <PanelHeader size="sm" />
            ...
            <CardBody>
                ...
                <Row>
                    ...
                    <FormGroup>
                        <label>인원</label>
                        <Input onChange={onChange}
                            placeholder="personnel" name="personnel"
                            type="number" value={personnel}
                        />
                    </FormGroup>
                    </Col>
                </Row>
                ...
                <Row>
                    <Col className="pr-1" md="3">      
                        시작
                        <Input onChange={onChange}
                            placeholder="startDay" name="startDay"
                    ...
                    <Col className="pr-1" md="3">     
                        끝
                        <Input onChange={onChange}
                            placeholder="endDay" name="endDay"
                            type="date" value={endDay}
                        /> 
                    </Col>
                </Row>
                <Row>
